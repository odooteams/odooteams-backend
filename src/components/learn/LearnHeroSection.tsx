      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {t('Open Source Projects & Code', 'مشاريع وأكواد مفتوحة المصدر')}
          </h1>
          <p className="text-xl opacity-90 mb-8">
            {t(
              'Explore our open source Programming projects and repositories. Request source code access or download directly.',
              'استكشف مشاريعنا وحلول أودو مفتوحة المصدر. يمكنك طلب الكود المصدري أو تحميله مباشرة.'
            )}
          </p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-grow">
                ...
                <input
                  type="text"
                  placeholder={t('Search open source projects...', 'بحث في المشاريع مفتوحة المصدر...')}
