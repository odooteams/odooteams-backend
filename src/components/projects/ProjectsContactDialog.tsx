...
const ProjectsContactDialog: React.FC<ProjectsContactDialogProps> = ({
  open,
  onOpenChange,
  projectTitle,
  projectCost,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        {!isSubmitted ? (
          <>
            <DialogHeader>
              <DialogTitle>{t('Contact Us', 'اتصل بنا')}</DialogTitle>
              {projectTitle && (
                <DialogDescription>
                  {projectTitle}
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
                ...
                <DialogFooter className="pt-4">
                  <Button type="submit" className="bg-odoo-gold hover:bg-yellow-500 text-odoo-purple">
